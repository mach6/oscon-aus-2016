...
package com.mycompany.myproject.logging;
...
public final class AppLogger {
    ...
    private static SimpleLoggerSettings getDefaultLoggerSettings(){
        ...
        settings.setUserLogFileName("oscon2016.log");
        settings.setDeveloperLogFileName("oscon2016-detailed.log");
        settings.setIdentifier("1.0.0-SNAPSHOT");

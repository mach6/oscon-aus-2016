...
public class DemoYamlDataProviderTest {
    private static String FILE_NAME = "src/test/resources/testdata/datafile.yaml";
    ...
    public Iterator<Object[]> filteredDataProvider () throws IOException{
        ...
        return dataProvider.getDataByFilter(new SimpleIndexInclusionFilter("1-2"));
    }
